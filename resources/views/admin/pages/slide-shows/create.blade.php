    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Add New Slide Show</h3>
            ...
            <form action="{{ route('admin.slide-shows.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control @error('image') is-invalid @enderror"
                                       ...
                                       onchange="previewImage(this, 'image-preview')" required>
                                <small class="form-text text-muted">Recommended size: 1920x1080px. Max size: 5MB</small>
                                @error('image')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                        ...
                        <div id="action-button-fields" style="display: {{ old('enable_action_button') ? 'contents' : 'none' }};">
                            <div class="col-md-6">
                                <div class="form-group">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Create Slide Show
                    </button>
