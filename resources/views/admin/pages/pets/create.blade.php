...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form action="{{ route('admin.pets.store') }}" method="POST" id="petForm" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('call_name') is-invalid @enderror"
                                       id="call_name" name="call_name" value="{{ old('call_name') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('sire_name') is-invalid @enderror"
                                       id="sire_name" name="sire_name" value="{{ old('sire_name') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('dam_name') is-invalid @enderror"
                                       id="dam_name" name="dam_name" value="{{ old('dam_name') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('breeder_name') is-invalid @enderror"
                                       id="breeder_name" name="breeder_name" value="{{ old('breeder_name') }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('category') is-invalid @enderror" id="category" name="category">
                                    ...
                                    <option value="Puppies" {{ old('category') == 'Puppies' ? 'selected' : '' }}>Puppies</option>
                                    <option value="Breeding Dog" {{ old('category') == 'Breeding Dog' ? 'selected' : '' }}>Breeding Dog</option>
                                    <option value="Companion Dog" {{ old('category') == 'Companion Dog' ? 'selected' : '' }}>Companion Dog</option>
                                </select>
                                @error('category')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('available_status') is-invalid @enderror" id="available_status" name="available_status">
                                    <option value="available" {{ old('available_status', 'available') == 'available' ? 'selected' : '' }}>Available</option>
                                    <option value="not available" {{ old('available_status') == 'not available' ? 'selected' : '' }}>Not Available</option>
                                </select>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="is_featured_dog"
                                           name="is_featured_dog" value="1" {{ old('is_featured_dog') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control @error('ref_link') is-invalid @enderror"
                                       id="ref_link" name="ref_link" value="{{ old('ref_link') }}"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          placeholder="Enter pet description">{{ old('description') }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="primaryImgFile">Upload Primary Image</label>
                                <input type="file" class="form-control" id="primaryImgFile" accept="image/*">
                                <small class="form-text text-muted">Select an image to crop it to 300x300 pixels</small>

                                <div id="primaryImagePreview" class="mt-3" style="display: none;">
                                    <strong>Cropped Preview:</strong>
                                    <div class="mt-2">
                                ...
                                <input type="hidden" name="primaryImg" id="primaryImgData">
                            </div>
                        </div>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Create Pet
                    </button>
...
<style>
    /* Checkerboard background for transparent PNG images */
    .cropper-bg {
